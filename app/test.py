...
def quick_detect(image1_path, image2_path, model_path=None, show_plot=False):
    """
    ...
    if model_path is None:
        model_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 
                                'siamese_change_detection_model_50.pth')
    ...
    # Save result for display in Streamlit
    result_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'temp', 'result.jpg')
    plt.imsave(result_path, binary_mask, cmap='gray')
